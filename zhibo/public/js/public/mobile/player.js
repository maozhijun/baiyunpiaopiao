...
function LoadVideo () {
	...
	if (CID && CID != '' && false) {
		...
		// var Link = 'http://61.160.199.164/chushou_live/e5962643111941ac8855991bb1a99ff9/87c4e276-d53f-4282-8fc0-b59f62a1d7f0/playlist.m3u8?Subm3u8=true&UliveHost=uclive-hls.kascend.com';
		// var Link = 'rtmp://wv4.tp33.net/sat//tv731';
		// var Link = 'http://txcdn.f01.xiaoka.tv/live/0NSjM71licWUd7wz.flv';
		var Link = 'https://goodgame.ru/player?1168';

		if (Link.indexOf('sportstream365.com') != -1){
			var ID = 1118354;
