    ...
    <div class="future default" id="Data_Future">
        ...
        <div class="host">
            ...
            <table>
                ...
                @component("pc.detail.football_cell.schedule_item",['teamId'=>$match['hid'],'teamName'=>$match['hname'],'matches'=>$data['home']])
                @endcomponent
            </table>
        </div>
        <div class="away">
            ...
            <table>
                ...
                @component("pc.detail.football_cell.schedule_item",['teamId'=>$match['aid'],'teamName'=>$match['aname'],'matches'=>$data['away']])
                @endcomponent
            </table>
        </div>
        <div class="clear"></div>
