...
<div class="sameOdd default" id="Characteristic_SameOdd" type="{{$od_type}}" count="10">
    ...
    @component('pc.detail.football_cell.characteristic_odd',['type'=>1,'count'=>10,'result'=>'1','data'=>$sameOdd])
    @endcomponent
    @component('pc.detail.football_cell.characteristic_odd',['type'=>1,'count'=>20,'result'=>'1','data'=>$sameOdd])
    @endcomponent
    @component('pc.detail.football_cell.characteristic_odd',['type'=>2,'count'=>10,'result'=>'2','data'=>$sameOdd2])
    @endcomponent
    @component('pc.detail.football_cell.characteristic_odd',['type'=>2,'count'=>20,'result'=>'2','data'=>$sameOdd2])
    @endcomponent
    @component('pc.detail.football_cell.characteristic_odd',['type'=>3,'count'=>10,'result'=>'3','data'=>$sameOdd3])
    @endcomponent
    @component('pc.detail.football_cell.characteristic_odd',['type'=>3,'count'=>20,'result'=>'3','data'=>$sameOdd3])
    @endcomponent
</div>