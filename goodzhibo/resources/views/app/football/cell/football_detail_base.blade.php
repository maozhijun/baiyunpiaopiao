        ...
        <ul>
            <li>
                ...
                <dl>
                    ...
                    <dt>黄牌</dt>
                    <dd class="away"><p>{{empty($match['a_yellow']) ? 0 : $match['a_yellow']}}</p><span style="width: {{108 * $match['a_y_p']}}px;"></span></dd>
                </dl>
                <dl>
                    <dd class="host"><p>{{empty($match['h_red']) ? 0 : $match['h_red']}}</p><span style="width: {{108 * $match['h_r_p']}}px;"></span></dd>
                    <dt>红牌</dt>
                    <dd class="away"><p>{{empty($match['a_red']) ? 0 : $match['a_red']}}</p><span style="width: {{108 * $match['a_r_p']}}px;"></span></dd>
                </dl>
                <dl>
