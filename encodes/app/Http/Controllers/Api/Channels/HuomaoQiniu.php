...
class HuomaoQiniu  extends Channel
{
    public $id = 308;//平台ID
    ...
    /**
     * 房间地址：https://www.huomao.com/4428
     * 房间号 4428、954218
     */
    const STREAM_ANCHOR_ROOMS = [
        954218, 661469, 533748, 771852, 895535,
        268462, 973614, 488796, 738096, 828107,
        719694, 528238
    ];
...
//        dump($json);
        ...
        if (!empty($json['data']) && !empty($json['data']['stream'])) {
            ...
            if ($pushUrl != "") {
                ...
                $result['stream_url'] = "rtmp://pili-publish.huomao.com/huomao/";
                $result['stream_name'] = $streamId.str_replace("k=", "key=", $stream_name);
                $result['play_flv'] = "http://pili-live-hdl.huomao.com/huomao/$streamId.flv";
                $result['play_m3u8'] = "http://pili-live-hdl.huomao.com/huomao/$streamId.m3u8";
            }
        }
        return $result;
    }
